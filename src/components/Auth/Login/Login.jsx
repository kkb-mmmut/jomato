    ...
    let loginDiv =  (
        <div className={loginCss.outerDiv}>
            <div className={loginCss.modal}>
                ...
                <div className={loginCss.newToZomato}>New to Jomato? <div className={loginCss.createAcc} onClick={() => setAuth({ closed: false, login: false, signup: true })}>Create Account</div></div>
            </div>
        </div>  
    )
